...
public class b2b3Jpanel1 extends JPanel{
	
	private ImageIcon frameIcon =new ImageIcon("picture/操作面板.png");
	private JButton returnButton;
	private ImageIcon returnIcon=new ImageIcon("picture/返回.png");
	public b2b3Jpanel1(b2financialstaffui b2financialstaffui,financialstaffJpanel financialstaffJpanel) {
	...
	private void registListener(final b2financialstaffui b2financialstaffui,final financialstaffJpanel financialstaffJpanel,final b2b3Jpanel1 b2b3Jpanel1){
