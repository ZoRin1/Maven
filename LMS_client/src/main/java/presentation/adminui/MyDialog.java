...
class DisplayDialog extends JDialog{
	...
	public DisplayDialog(JFrame frame,String title,boolean modal,String words) {
...
class AskDialog extends JDialog{
	...
	private void init(){
		state = false;
		ImageIcon confirmIcon = new ImageIcon("picture/取消.png");
		ImageIcon cancelIcon=new ImageIcon("picture/对话框确定.png");
