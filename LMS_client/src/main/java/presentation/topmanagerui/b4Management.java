...
public class b4Management extends JPanel {
	...
	public b4Management(b4topmanagerui b4ui,topmanagerJpanel topmanagerJpanel) {
		...
		registListener(b4ui, topmanagerJpanel, this);
	}
	...
	private void registListener(final b4topmanagerui  b4ui,final topmanagerJpanel tjpl,final b4Management b4Management) {
		...
		fukuan.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO 自动生成的方法存根
				tjpl.remove(b4Management);
				tjpl.add(new b4Managment2(b4topmanagerui, tjpl));
				tjpl.repaint();
			}
		});
