...
import presentation.financialstaffui.b1b1Jpanel1;
import vo.documentsVO.ReceiptVO;

public class b4ManagementTable {
	private JTable shoukuanJtabel;
	private b4Management b4manage;
	private JScrollPane scrollPane;
	private ArrayList<ReceiptVO> ReceiptList;
	
	
	public b4ManagementTable(b4Management b4management,ArrayList<ReceiptVO> ReceiptList) {
		// TODO Auto-generated constructor stub
		this.b4manage = b4management;
