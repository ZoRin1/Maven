...
public class stockDepotJTable1 {
	
	private JTable stockDepotTable;
	private stockDepotPanel1 stockDepotPanel1;
	...
	public stockDepotJTable1(stockDepotPanel1 stockDepotPanel1,ArrayList<InDepotInfVO> VOList){
		this.VOList = VOList;
		this.stockDepotPanel1 = stockDepotPanel1;
		initTable();
		init();
	}
	...
	private void init(){
		...
		stockDepotPanel1.add(scrollPane);
	}
